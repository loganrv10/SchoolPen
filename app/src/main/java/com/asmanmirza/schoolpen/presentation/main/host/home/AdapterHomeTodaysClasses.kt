...
import com.asmanmirza.schoolpen.presentation.main.periods.studentperiods.StudentPeriodsActivity
import com.bumptech.glide.Glide
import de.hdodenhof.circleimageview.CircleImageView

class AdapterHomeTodaysClasses (var context: Context, var data:ArrayList<ModelClasses>) : PagerAdapter() {
    ...
    fun setData(itemView: View, position:Int){
        ...
        itemView.setOnClickListener {
            if(position == 0){
                context.startActivity(Intent(context, StudentPeriodsActivity::class.java))
            }else{
