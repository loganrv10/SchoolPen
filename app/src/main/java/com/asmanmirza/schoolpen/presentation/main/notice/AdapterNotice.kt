package com.domonz.schoolpen_aie.Adapters
...
import com.asmanmirza.schoolpen.presentation.main.notice.ModelNotice
...
class AdapterNotice(var context: Context, var data:ArrayList<ModelNotice>) : RecyclerView.Adapter<AdapterNotice.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: AdapterNotice.ViewHolder, position: Int) {
