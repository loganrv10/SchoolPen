...
class AdapterEvents(var context: Context, var data:ArrayList<ModelEvents>):RecyclerView.Adapter<AdapterEvents.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_calendar_events, parent, false))
    }
